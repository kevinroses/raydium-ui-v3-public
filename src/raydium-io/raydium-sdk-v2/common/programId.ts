...
// export const CLMM_PROGRAM_ID = new PublicKey("devi51mZmdwUJGU9hjN27vEz64Gps7uUefqxg27EAtH"); // 合约地址
export const CLMM_PROGRAM_ID = new PublicKey("9ca2LJFcwqoDfrbWQd4AXVK9v3fwwAKUmrR9oyXqVghH"); // 合约地址
...
export const DEVNET_PROGRAM_ID = {
  ...
  // CLMM: new PublicKey("devi51mZmdwUJGU9hjN27vEz64Gps7uUefqxg27EAtH"),// 合约地址
  CLMM: new PublicKey("9ca2LJFcwqoDfrbWQd4AXVK9v3fwwAKUmrR9oyXqVghH"),// 合约地址
